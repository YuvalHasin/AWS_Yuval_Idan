...
const CPADashboard = () => {
  ...
  const statsCards = [
    ...
    { title: 'Docs to Review', value: clients.filter(c => c.docsCount === 0).length, icon: AssessmentIcon, color: '#ef4444', bgColor: '#fef2f2' },
    { title: 'Monthly Revenue', value: `₪${(clients.length * 500).toLocaleString()}`, icon: TrendingUpIcon, color: '#22c55e', bgColor: '#f0fdf4' },
  ];
